...
class VNPay
{
     ...
     *
     */
    static $vnp_TmnCode = "JPRSE4UB"; //Mã website tại VNPAY
    static $vnp_HashSecret = "WEZFKHEMQKBRZBZFERCGAUYDPFDWYTUP"; //Chuỗi bí mật
    ...
    public static function vnpay_create_payment(array $data)
    {
        ...
        $vnp_OrderType = 110000; // Loại hàng hóa: Thực Phẩm - Tiêu Dùng (Xem thêm mã tại: https://sandbox.vnpayment.vn/apis/docs/loai-hang-hoa)
