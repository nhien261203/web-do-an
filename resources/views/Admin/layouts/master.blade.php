...
<head>
    ...
    <title>@yield('title') | DuogBachMobile</title>
    <base href="/admin/">
    ...
    <div class="app-container app-theme-white body-tabs-shadow fixed-header fixed-sidebar">
        <div class="app-header header-shadow">
            <div class="app-header__logo">
                ...
                <div class="app-sidebar__heading"><a class="text-decoration-none" href="/quantri">DuogBachMoBile</a></div>
                                            ...
                                            <ul class="nav flex-column">
                                                ...
                                                <li class="nav-item-btn text-center nav-item">
                                                    <button class="btn-wide btn btn-primary btn-sm" id="myFacebook" onclick=""> Facebook
                                                        <!-- <script>
                                                            let myFacebook = document.querySelector('#myFacebook');
                                                            myFacebook.addEventListener('click', function(e){
                                                                // e.defaultPrevented();
                                                                window.location.hostname = 'https://www.facebook.com/duogbachdev'
                                                            })
                                                        </script> -->
